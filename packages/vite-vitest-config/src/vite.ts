import { type UserConfigExport, type Plugin, defineConfig } from "vite";
...
export type GenerateViteConfigOptions = Partial<typeof DEFAULT_VITE_OPTIONS> & { overrides?: UserConfigExport };

function getAppConfig(projectName: string, projectRoot: string, options: GenerateViteConfigOptions): UserConfigExport {
...
function getLibConfig(projectName: string, options: GenerateViteConfigOptions): UserConfigExport {
	return {
...
export function generateViteConfig(
	...
	projectName: string,
	projectRoot: string,
	options: GenerateViteConfigOptions = DEFAULT_VITE_OPTIONS
): UserConfigExport {
